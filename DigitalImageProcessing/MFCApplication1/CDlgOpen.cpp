...
IMPLEMENT_DYNAMIC(CDlgOpen, CDialogEx)

CDlgOpen::CDlgOpen(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_Open, pParent)
{
	m_nMode = -1;
	m_nStructure1 = -1;
	m_nStructure2 = -1;
...
BEGIN_MESSAGE_MAP(CDlgOpen, CDialogEx)
